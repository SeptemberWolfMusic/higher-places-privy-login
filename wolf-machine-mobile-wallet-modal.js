...
modal.innerHTML = `
  <div style="${cardStyle}">
    <div style="font-size:1.8rem; font-weight:700; color:#CAF5FA; text-align:center; margin-bottom:0.0rem;">
      No wallet detected.
    </div>
  ...
  display: inline-block; width: max-content; padding-left: 16px;
  ">
